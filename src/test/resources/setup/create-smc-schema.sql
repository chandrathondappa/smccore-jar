...
(
   HEADER_ID int PRIMARY KEY NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   DCN int,
   SCH_A_NO varchar(10),
   CORP char(4) NOT NULL,
   PO_NUMBER int NOT NULL,
...
CREATE TABLE SMC.SMC_PURCHASING_DETAILS(
	HEADER_DETAIL_ID		INTEGER			NOT NULL,
	LOADSHEET_SEQ_NO		INTEGER			NOT NULL,
	PO_NUMBER				INTEGER			NOT NULL,
	CO_NUMBER				INTEGER			NOT NULL,
	CANCEL_SEQ				INTEGER			NOT NULL,
	VENDOR_VISIBILITY		CHAR(1)			NULL,
	IS_FULL_QUOTE			CHAR(1)			NULL,
	PO_QUANTITY				INTEGER			NOT NULL,
	ISSUE_DATE				TIMESTAMP		NULL,
	RELEASE_TYPE			CHAR(1)			NULL,
	RELEASE_DATE			TIMESTAMP		NULL,
	RELEASED_BY				VARCHAR(100)	NULL,
	IS_PDF_GENERATED		CHAR(1)			NOT NULL,
	IS_DOCUMENT_REVIEWED	CHAR(1)			NULL,
	DOCUMENT_REVIEWED_DATE	TIMESTAMP		NOT NULL,
	IS_REPLACEMENT			CHAR(1)			NOT NULL,
	EDI_FLAG				CHAR(1)			NULL,
	STATUS					VARCHAR(15)		NULL,
	STATUS_CHANGE_DATE		TIMESTAMP		NULL,
	CONFIRMED_BY			VARCHAR(100)	NOT NULL,
	CONFIRMED_DATE			TIMESTAMP		NOT NULL,
	T_C_VERSION				INTEGER			NOT NULL,
	CREATED_BY				VARCHAR(100)	NOT NULL,
	CREATED_DATE			TIMESTAMP		NOT NULL,
	MODIFIED_BY				VARCHAR(100)	NULL,
	MODIFIED_DATE			TIMESTAMP		NULL,
	POPULATED_BY			VARCHAR(100)	NULL,
	POPULATED_DATE			TIMESTAMP		NULL,
	IS_VISIBLE_TO_VENDOR	VARCHAR(1)		NULL,
	IS_INTERNAL_ORDER		CHAR(1)			NULL
);

CREATE TABLE SMC.SMC_VENDOR_MASTER
(
   VENDOR_ID int PRIMARY KEY NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   CORP char(4) NOT NULL,
...
CREATE TABLE SMC.SMC_TAB_TEMPLATE_MAP
(
   MAP_ID int PRIMARY KEY NOT NULL GENERATED ALWAYS AS IDENTITY,
   TEMPLATE_ID int NOT NULL,
   TAB_ID int NOT NULL
);
...
CREATE TABLE SMC.SMC_PRODUCTION_SUMMARY(
	...
	COOLING_UNIT_ESTIMATED_PRODUCTION_DATE	DATE			NULL
);
